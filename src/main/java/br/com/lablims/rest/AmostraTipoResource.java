...
@RestController
@RequestMapping(value = "/api/amostraTipos", produces = MediaType.APPLICATION_JSON_VALUE)
@PreAuthorize("hasAuthority('" + UserRoles.ADMIN + "')")
public class AmostraTipoResource {

    private final AmostraTipoService amostraTipoService;

    public AmostraTipoResource(final AmostraTipoService amostraTipoService) {
    ...
    @GetMapping
    public ResponseEntity<SimplePage<AmostraTipoDTO>> getAllAmostraTipos(
